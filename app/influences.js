...
window.INFLUENCES = [
  ...
  { cat: "Aquatik-Chemie & -Physik", icon: "waves", factors: [
    ...
    { name: "Saures Wasser (pH)", desc: "Saure Moore gegenüber alkalischen Soda-Seen.", soon: true },
  ...
  { cat: "Boden & Minerale", icon: "mineral", factors: [
    ...
    { name: "Serpentin / Schwermetall", desc: "Giftige Metalle im Boden → nur spezialisierte Metallophyten.", soon: true },
  ...
  { cat: "Energie & Extrem-Chemie", icon: "cell", factors: [
    ...
    { name: "Schwefel- & Säure-Extrem", desc: "Extremophile in H₂S, hypersalin, Säure oder Lauge.", soon: true },
  ]},
